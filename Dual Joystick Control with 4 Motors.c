...
|*                                                                                                    *|
|*  This program uses both the Left and the Right joysticks to run the robot using "RegSpeed control".    *|
|*                                                                                                    *|
|*                                        ROBOT CONFIGURATION                                         *|
|*    NOTES:                                                                                          *|
...
|*    Motor Port 1        frontRightMotor       VEX 3-wire module     Right side motor                *|
|*    Motor Port 2        backRightMotor        VEX 3-wire module     Right side motor                *|
|*    Motor Port 3        frontLefttMotor       VEX 3-wire module     Left side motor                 *|
|*    Motor Port 4        backLeftMotor         VEX 3-wire module     Left side motor                 *|
\*----------------------------------------------------------------------------------------------------*/
